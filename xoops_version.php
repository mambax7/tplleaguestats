...
$modversion['config'][5] = ['name' => 'fordraw', 'title' => '_MI_PREFPTSDRAW', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => 1];

$modversion['config'][6] = ['name' => 'forloss', 'title' => '_MI_PREFPTSLOSS', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => 0];

$modversion['config'][7] = ['name' => 'topoftable', 'title' => '_MI_PREFTOPCOL', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'text', 'default' => '#CCCCCC'];

$modversion['config'][8] = ['name' => 'bg1', 'title' => '_MI_PREFLISTTMBG', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'text', 'default' => '#DEDEDE'];

$modversion['config'][9] = ['name' => 'bg2', 'title' => '_MI_PREFMAINCOLSBG', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'text', 'default' => '#FFFFCC'];

$modversion['config'][10] = ['name' => 'inside', 'title' => '_MI_PREFTTABBGCOL', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'text', 'default' => '#FFFFFF'];

$modversion['config'][11] = ['name' => 'bordercolour', 'title' => '_MI_PREFTABBDRCOL', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'text', 'default' => '#CCCCCC'];

$modversion['config'][12] = ['name' => 'tablewidth', 'title' => '_MI_PREFWIDTH', 'description' => '', 'formtype' => 'textbox', 'valuetype' => 'int', 'default' => '650'];
